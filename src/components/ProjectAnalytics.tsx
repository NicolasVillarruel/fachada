    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col gap-4 h-full">
          {/* Status indicator */}
          <div className={`p-5 rounded-[2rem] border shadow-lg backdrop-blur-xl flex flex-col justify-between flex-1 transition-all ${
            ...
            <div>
              <h4 className={`text-xl font-black font-manrope leading-tight ${isDelayed ? 'text-red-500' : 'text-green-500'}`}>
          ...
          {/* Velocity */}
          <div className="p-5 rounded-[2rem] bg-brand-blue/5 border border-brand-blue/20 shadow-lg backdrop-blur-xl flex flex-col justify-between flex-1">
            <span className="text-[9px] font-black uppercase tracking-widest opacity-60 text-brand-blue">Velocidad</span>
            <div>
              <h4 className="text-xl font-black font-manrope text-brand-blue leading-tight">
          ...
          {/* Estimated End */}
          <div className="p-5 rounded-[2rem] bg-brand-purple/5 border border-brand-purple/20 shadow-lg backdrop-blur-xl flex flex-col justify-between flex-1">
          ...
          {/* Breach */}
          <div className="p-5 rounded-[2rem] bg-card border border-card-border shadow-lg backdrop-blur-xl flex flex-col justify-between flex-1">
            <span className="text-[9px] font-black uppercase tracking-widest opacity-60 text-muted">Diferencia</span>
            <div>
               <h4 className={`text-xl font-black font-manrope leading-tight ${currentProgress >= expectedProgressToday ? 'text-green-500' : 'text-accent'}`}>
