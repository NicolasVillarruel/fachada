            ...
            <div className="flex-1 min-w-0 w-full">
              ...
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full min-w-0 overflow-hidden bg-background/50 border border-card-border rounded-xl pl-9 pr-2 py-2.5 focus:outline-none focus:ring-1 focus:ring-accent transition-all font-inter text-sm"
                />
              </div>
            </div>
            <div className="flex-1 min-w-0 w-full">
              ...
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full min-w-0 overflow-hidden bg-background/50 border border-card-border rounded-xl pl-9 pr-2 py-2.5 focus:outline-none focus:ring-1 focus:ring-accent transition-all font-inter text-sm text-accent font-bold"
                />
              </div>
            </div>
          </div>
