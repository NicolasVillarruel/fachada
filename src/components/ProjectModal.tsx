        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
            <div className="min-w-0 w-full max-w-full">
              <label className="block text-[9px] font-black uppercase tracking-[0.2em] text-muted mb-1.5 truncate">Fecha Inicio</label>
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full max-w-full min-w-0 overflow-hidden bg-background/50 border border-card-border rounded-xl pl-9 pr-2 py-2.5 focus:outline-none focus:ring-1 focus:ring-accent transition-all font-inter text-sm"
                />
              </div>
            </div>
            <div className="min-w-0 w-full max-w-full">
              <label className="block text-[9px] font-black uppercase tracking-[0.2em] text-muted mb-1.5 truncate">Fecha Entrega</label>
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full max-w-full min-w-0 overflow-hidden bg-background/50 border border-card-border rounded-xl pl-9 pr-2 py-2.5 focus:outline-none focus:ring-1 focus:ring-accent transition-all font-inter text-sm text-accent font-bold"
                />
              </div>
            </div>
          </div>
